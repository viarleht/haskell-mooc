...
countHelper x sum = sum + maybe 1 (const 0) x
...
-- Can you do this without creating a list?
maxHelper a max = maximum[a,max]
...
lastHelper _ (Just b) = Just b
lastHelper a _  = Just a
